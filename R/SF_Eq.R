...
#' as well as the r squared and adj R squared, under equilibrium assumption using Schaefer
#' and Fox models (Sparre and Venema, 1998).
#'
#' This is just for educational purposes, do not use the result of this analysis
#' for management purposes as assumptions in this approach is rarely met and usually leads
#' to potential yield and optimum effort overestimation (Hilborn and Walter, 1992; Polacheck, et al. 1993)
#'
...
#' Part I: Manual. FAO Fisheries Technical Paper, 306, 1.
#'
