...
#'
#' @description
#' Function to create projection in Schaefer's model based on different reference points (Bmsy, MSY, Emsy).
#'
...
#TAC <- .5
#test <- SPprojS_temp(inpars=inpars, df=goodcontrast, nyears=30, TAC=TAC, sigma=0.000001)

#print(c("TAC =", ifelse(TAC < 1, (1-TAC), TAC), "Bmsy"))

#plot(test[[1]][,5], type="l", col="red", ylab="B/Bmsy", xlab="year")
#lines(test[[2]][,5], type="l", col="black")
#lines(test[[3]][,5], type="l", col="blue")
