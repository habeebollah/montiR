#' @title demersal trawl fishery data
#'
#' @description A data set containing year, catch and effort from trawl to catch demersal fish in north java sea, Indonesia.
#'
