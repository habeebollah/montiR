...
#'
#' @description
#' Function used in the maximum likelihood minimization to estimate Schaefer's biomass dynamic model parameters using lognormal distribution. The use of lognormal in maximum likelihood is important to remove potential error during data collection  (Polacheck et al., 1993).
