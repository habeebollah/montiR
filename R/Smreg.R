...
#'
#' @description This function calculate MSY and Emsy, as well as the r squared and adj R squared
#' under non-equilibrium assumption.
#' The least square in the Walters and Hilborn (1976)'s multiple regression produces bias
#' parameter (Uhler, 1979), which not advised to be used as it would result in further bias when calculating MSY and Emsy.
...
#'
#' @references
#' Carl J. Walters and Ray Hilborn. 1976. Adaptive Control of Fishing Systems. Journal of
#' the Fisheries Research Board of Canada. 33(1): 145-159
#'
#' Uhler, R. S. 1979. Least squares regression estimates of the Schaefer production model:
#' some Monte Carlo simulation results. Can. J. Fish. Aquat. Sci. 37: 1284-1294.
#'
