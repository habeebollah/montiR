...
#'
#' @description
#' Function used in the maximum likelihood minimization to estimate Schaefer's reference points using lognormal distribution. The use of maximum likelihood is important to remove potential error during data collection.
...
#' RPparS_val <- data.frame(RPpar = c("Bmsy", "MSY", "Emsy", "B0", "sigma"),
